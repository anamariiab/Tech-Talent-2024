...
public class ViewCientificos extends JFrame {
    ...
    public void mostrarCientificos(Object[][] datos) {
        modeloTabla.setDataVector(datos, new Object[]{"DNI", "Nombre y Apellidos"});
    }

    public void agregarCientificoATabla(String dni, String nombreApellidos) {
        modeloTabla.addRow(new Object[]{dni, nombreApellidos});
    }
